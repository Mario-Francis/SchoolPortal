...
{
    public partial class Created_View_For_EndTermResults : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                create view EndTermResults_View as
                    select CONCAT_WS(' ', st.FirstName, st.MiddleName, st.Surname) as StudentName, st.AdmissionNo, e.Session, e.Term, e.ExamTypeId, e.ExamType, c.ClassName, cr.RoomCode, CONCAT(s.Name,' (', s.Code,')') as SubjectName, mr.Total as MidTermTotal, mr.Id as MidTermResultId, r.* 
