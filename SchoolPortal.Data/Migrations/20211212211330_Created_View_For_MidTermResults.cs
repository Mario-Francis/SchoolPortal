...
{
    public partial class Created_View_For_MidTermResults : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                create view MidTermResults_View as
                    select CONCAT_WS(' ', st.FirstName, st.MiddleName, st.Surname) as StudentName, st.AdmissionNo, e.Session, e.Term, e.ExamTypeId, e.ExamType, c.ClassName, cr.RoomCode, CONCAT(s.Name,' (', s.Code,')') as SubjectName, r.* 
